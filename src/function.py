...
# def extrair_zip(caminhos_zip, diretorio_destino):
#     """
#     Extrai arquivos .zip para o diretório de destino fornecido.

#     :param caminhos_zip: Lista com os caminhos dos arquivos .zip
#     :param diretorio_destino: Caminho do diretório onde os arquivos serão extraídos
#     """
...
#                 print(f"Arquivo {caminho_zip} extraído com sucesso para {diretorio_destino}")
